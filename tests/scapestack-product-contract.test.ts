...
describe("Scapestack anti-bankstanding product contract", () => {
  it("keeps the core promise simple and OSRS-native", () => {
    ...
    expect(next).toContain("One best move for this account. Two alternatives");
    ...
    expect(next).toContain("Not feeling this?");
    expect(next).toContain("Pick a different kind of session.");
