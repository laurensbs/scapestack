...
describe("Goals data source copy", () => {
  ...
  it("opens with a companion-style next unlock instead of a status dashboard", () => {
    ...
    expect(source).toContain("Open steps");
    ...
    expect(source).toContain("Already checked");
    expect(source).toContain("Back to unlocks");
    ...
    expect(source).toContain("Add more context");
    expect(source).not.toContain("Make rewards smarter");
