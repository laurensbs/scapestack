  ...
  if (!spriteId || stage === "dot") {
    return (
      <span
        ...
        className={cn(
          "inline-flex flex-col items-center justify-center gap-0.5 rounded-sm border border-[var(--color-border)] bg-[var(--color-bg)]/80 text-[9px] font-black leading-none text-[var(--color-accent)] shadow-[0_0_10px_rgba(230,165,47,0.2)]",
          className
        )}
        style={{
          width: size ?? 18,
