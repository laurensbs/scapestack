  ...
  return (
    <section className="mb-8 animate-[slide-up_0.4s_ease-out]">
      ...
      {/* Step rail — numbered nodes joined by a progress line. Each step
          ...
          never passes through them. The connector fills blue-gray once the
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  done && "bg-[var(--color-accent)] text-[var(--color-bg)] border-[var(--color-accent)] shadow-[0_0_0_4px_rgba(134, 166, 217,0.12)]",
                  current && !done && "bg-[var(--color-accent)]/15 text-[var(--color-accent)] border-[var(--color-accent)] shadow-[0_0_0_4px_rgba(134, 166, 217,0.1)]",
...
function ScreenshotFrame({ src, alt, w, h }: { src: string; alt: string; w: number; h: number }) {
  return (
    <div className="relative rounded-none overflow-hidden border border-[var(--color-border-strong)] bg-[var(--color-bg-2)] p-4 flex items-center justify-center">
      <span
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 h-px"
        style={{ background: "linear-gradient(to right, transparent, rgba(134, 166, 217,0.45), transparent)" }}
      />
      <img
        src={src}
        alt={alt}
    ...
    <svg viewBox="0 0 240 160" className="w-full max-w-[260px] h-auto">
      <defs>
        <linearGradient id="paste-top" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0" stopColor="rgba(134, 166, 217,0)" />
          <stop offset="0.5" stopColor="rgba(134, 166, 217,0.45)" />
          <stop offset="1" stopColor="rgba(134, 166, 217,0)" />
        </linearGradient>
      </defs>
  ...
  return (
    <svg viewBox="0 0 240 160" className="w-full max-w-[260px] h-auto">
      ...
      <g transform="translate(8, 12)">
        ...
        <rect x="86" y="29" width="34" height="16" rx="4" fill="rgba(134, 166, 217,0.15)" stroke="var(--color-good)" />
