  ...
  if (stage === "dot" || (!boss.iconItemId && stage !== "local")) {
    ...
    return (
      <span
        ...
        className="inline-flex items-center justify-center rounded-full border border-[var(--color-border)] bg-[var(--color-accent)]/14 text-[9px] font-black leading-none text-[var(--color-accent)] shadow-[0_0_10px_rgba(15, 118, 110,0.25)]"
        ...
        >
          <div className="relative px-3 pt-3 pb-2 border-b border-[var(--color-border)]">
            ...
            <input
              ...
              className="w-full pl-7 pr-7 py-1.5 rounded-md text-[12.5px] bg-[var(--color-bg-2)] border border-[var(--color-border)] text-[var(--color-text)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:border-[var(--color-accent)] focus:shadow-[0_0_0_3px_rgba(15, 118, 110,0.12)]"
            />
