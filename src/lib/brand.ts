...
// The Journal ground, not near-black: the browser chrome should match
// the page it frames.
export const BRAND_THEME_COLOR = "#1C1811";
...
export const BRAND_DESCRIPTION =
  "A premium OSRS trip planner: type your RSN and see what to do first, what to bring, what is missing and when to stop.";
