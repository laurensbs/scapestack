...
export const GEAR: GearItem[] = [
  ...
  { id: 23995, name: "Blade of Saeldor",    slot: "weapon", weaponStyle: "slash", speed: 4, attack: a({ slash: 94 }),                    other: { strength: 89, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 27690, name: "Voidwaker",           slot: "weapon", weaponStyle: "stab",  speed: 4, attack: a({ stab: 82, slash: 60 }),          other: { strength: 75, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 21003, name: "Elder maul",          slot: "weapon", weaponStyle: "crush", speed: 6, twoHanded: true, attack: a({ crush: 135 }),  other: { strength: 147, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 26374, name: "Zaryte crossbow",     slot: "weapon", weaponStyle: "ranged", speed: 5, attack: a({ ranged: 95 }),                  other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 4734,  name: "Karil's crossbow",    slot: "weapon", weaponStyle: "ranged", speed: 4, twoHanded: true, attack: a({ ranged: 65 }), other: { strength: 8, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 28922, name: "Tonalztics of ralos", slot: "weapon", weaponStyle: "ranged", speed: 5, twoHanded: true, attack: a({ ranged: 75 }), other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 30 } },
  ...
  // ── Weapons (magic) ──────────────────────────────────────────────────────
  { id: 27275, name: "Tumeken's shadow",    slot: "weapon", weaponStyle: "magic", speed: 5, twoHanded: true, attack: a({ magic: 35, crush: 30 }), other: { strength: 0, prayer: 0, magicDamage: 0.20, rangedStrength: 0 } }, // 3x multiplier handled separately
  { id: 22323, name: "Sanguinesti staff",   slot: "weapon", weaponStyle: "magic", speed: 4, twoHanded: true, attack: a({ magic: 25, crush: 25 }), other: { strength: 0, prayer: 0, magicDamage: 0.15, rangedStrength: 0 } },
  { id: 24423, name: "Harmonised nightmare staff", slot: "weapon", weaponStyle: "magic", speed: 4, twoHanded: true, attack: a({ magic: 22 }),    other: { strength: 0, prayer: 0, magicDamage: 0.18, rangedStrength: 0 } },
  ...
  { id: 27624, name: "Ancient sceptre",     slot: "weapon", weaponStyle: "magic", speed: 4, attack: a({ magic: 20 }),                            other: { strength: 0, prayer: 0, magicDamage: 0.10, rangedStrength: 0 } },

  // ── Helms ────────────────────────────────────────────────────────────────
  { id: 11865, name: "Slayer helmet (i)",   slot: "head", attack: zero,                                 other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  { id: 11864, name: "Slayer helmet",       slot: "head", attack: zero,                                 other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  { id: 10828, name: "Helm of neitiznot",   slot: "head", attack: zero,                                 other: { strength: 3, prayer: 3, magicDamage: 0, rangedStrength: 0 } },
  { id: 24271, name: "Neitiznot faceguard", slot: "head", attack: zero,                                 other: { strength: 6, prayer: 3, magicDamage: 0, rangedStrength: 0 } },
  { id: 12931, name: "Serpentine helm",     slot: "head", attack: zero,                                 other: { strength: 5, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  { id: 26382, name: "Torva full helm",     slot: "head", attack: zero,                                 other: { strength: 8, prayer: 1, magicDamage: 0, rangedStrength: 0 } },
  { id: 27235, name: "Masori mask (f)",     slot: "head", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 4 } },
  { id: 27226, name: "Masori mask",         slot: "head", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 4 } },
  { id: 21018, name: "Ancestral hat",       slot: "head", attack: a({ magic: 8 }),                      other: { strength: 0, prayer: 1, magicDamage: 0.02, rangedStrength: 0 } },
  { id: 26241, name: "Virtus mask",         slot: "head", attack: a({ magic: 7 }),                      other: { strength: 0, prayer: 1, magicDamage: 0.03, rangedStrength: 0 } },
  ...
  { id: 13124, name: "Ardougne cloak 4",    slot: "cape", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 19547, name: "Necklace of anguish", slot: "neck", attack: zero,                                 other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 5 } },
  { id: 12002, name: "Occult necklace",     slot: "neck", attack: a({ magic: 12 }),                     other: { strength: 0, prayer: 0, magicDamage: 0.10, rangedStrength: 0 } },
  { id: 29801, name: "Amulet of rancour",   slot: "neck", attack: zero,                                 other: { strength: 12, prayer: 2, magicDamage: 0, rangedStrength: 0 } },
  { id: 1704,  name: "Amulet of glory",     slot: "neck", attack: zero,                                 other: { strength: 6, prayer: 3, magicDamage: 0, rangedStrength: 0 } },
  { id: 12018, name: "Salve amulet(ei)",    slot: "neck", attack: zero,                                 other: { strength: 0, prayer: 0, magicDamage: 0.20, rangedStrength: 0 } }, // vs undead
  ...
  { id: 21021, name: "Ancestral robe top",  slot: "body", attack: a({ magic: 35 }),                     other: { strength: 0, prayer: 1, magicDamage: 0.02, rangedStrength: 0 } },
  { id: 26243, name: "Virtus robe top",     slot: "body", attack: a({ magic: 30 }),                     other: { strength: 0, prayer: 1, magicDamage: 0.03, rangedStrength: 0 } },
  { id: 27238, name: "Masori body (f)",     slot: "body", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 4 } },
  { id: 27229, name: "Masori body",         slot: "body", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 4 } },
  { id: 11828, name: "Armadyl chestplate",  slot: "body", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 21024, name: "Ancestral robe bottom", slot: "legs", attack: a({ magic: 30 }),                   other: { strength: 0, prayer: 1, magicDamage: 0.02, rangedStrength: 0 } },
  { id: 26245, name: "Virtus robe bottom",    slot: "legs", attack: a({ magic: 23 }),                     other: { strength: 0, prayer: 1, magicDamage: 0.03, rangedStrength: 0 } },
  { id: 27241, name: "Masori chaps (f)",    slot: "legs", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 3 } },
  { id: 27232, name: "Masori chaps",        slot: "legs", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 3 } },
  { id: 11830, name: "Armadyl chainskirt",  slot: "legs", attack: zero,                                 other: { strength: 0, prayer: 1, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 2577,  name: "Ranger boots",        slot: "feet", attack: zero,                                 other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 4 } },
  ...
  { id: 25486, name: "Magus ring",            slot: "ring", attack: zero, other: { strength: 0, prayer: 0, magicDamage: 0.04, rangedStrength: 0 } },
  { id: 25487, name: "Venator ring",          slot: "ring", attack: zero, other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 6 } },
  ...
  { id: 11771, name: "Archers ring (i)",      slot: "ring", attack: zero, other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 8 } },
  { id: 6733,  name: "Archers ring",          slot: "ring", attack: zero, other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 4 } },
  { id: 11770, name: "Seers ring (i)",        slot: "ring", attack: a({ magic: 8 }), other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  ...
  { id: 11772, name: "Warrior ring (i)",      slot: "ring", attack: zero, other: { strength: 4, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
  { id: 6735,  name: "Warrior ring",          slot: "ring", attack: zero, other: { strength: 0, prayer: 0, magicDamage: 0, rangedStrength: 0 } },

  // ── Shields ──────────────────────────────────────────────────────────────
  { id: 22322, name: "Avernic defender",    slot: "shield", attack: a({ stab: 30, slash: 29, crush: 28 }), other: { strength: 8, prayer: 0, magicDamage: 0, rangedStrength: 0 } },
