...
export const UPGRADES: Upgrade[] = [
  ...
  { id: 27690, name: "Voidwaker",           bucket: "Melee weapon", reqs: [{ skill: "Attack", level: 75 }],  approxPrice: 90_000_000,why: "Replaces dragon claws as the meta spec weapon." },
  ...
  { id: 26374, name: "Zaryte crossbow",     bucket: "Range weapon", reqs: [{ skill: "Ranged", level: 80 }],  approxPrice: 200_000_000,why: "Long-form range BIS — most raid bosses benefit." },
  ...
  { id: 22296, name: "Staff of light",      bucket: "Magic weapon", reqs: [{ skill: "Magic", level: 75 }],   approxPrice: 25_000_000,why: "Strong autocast + ironman-friendly." },
  { id: 22323, name: "Sanguinesti staff",   bucket: "Magic weapon", reqs: [{ skill: "Magic", level: 82 }],   approxPrice: 80_000_000,why: "Heals + huge magic damage at TOB / late-game slayer." },
  { id: 27275, name: "Tumeken's shadow",    bucket: "Magic weapon", reqs: [{ skill: "Magic", level: 85 }],   approxPrice: 1_700_000_000, why: "Magic Tbow. Triples gear + base magic damage." },
  // ── Helms ────────────────────────────────────────────────────────────────
  ...
  { id: 12931, name: "Serpentine helm",     bucket: "Helm", reqs: [{ skill: "Slayer", level: 75 }, { skill: "Defence", level: 50 }], approxPrice: 4_500_000, why: "Poison immunity + best strength helm under endgame." },
  { id: 10828, name: "Helm of neitiznot",   bucket: "Helm", reqs: [{ skill: "Defence", level: 55 }], approxPrice: 60_000, why: "Free prayer bonus + strength bonus. Quest reward — get it early." },
  ...
  { id: 2513, name: "Dragon chainbody",    bucket: "Body", reqs: [{ skill: "Defence", level: 60 }], approxPrice: 220_000, why: "Cheap melee defence + strength." },
  ...
  // ── Boots ────────────────────────────────────────────────────────────────
  { id: 3105,    name: "Climbing boots",      bucket: "Boots", reqs: [],                                approxPrice: 12_000, why: "Cheap +4 strength. First serious upgrade after rune boots." },
  ...
  // ── Gloves ───────────────────────────────────────────────────────────────
  { id: 11126, name: "Combat bracelet",     bucket: "Gloves", reqs: [{ skill: "Crafting", level: 58 }], approxPrice: 8_500, why: "+ Hits 4 wears for cheap +6 melee stats." },
  ...
  // ── Ring ─────────────────────────────────────────────────────────────────
  { id: 6737,  name: "Berserker ring",      bucket: "Ring", reqs: [{ skill: "Defence", level: 1 }], approxPrice: 2_500_000, why: "Cheap +4 strength ring before Brimstone." },
