...
console.log("top 12 by engine order:");
all.slice(0,12).forEach((r,i)=>console.log(` ${i+1}. [${r.kind}] ${r.title} (score ${r.score})`));
const rfd = all.findIndex(r=>r.title==="Do Recipe for Disaster");
console.log("RFD position:", rfd+1, "of", all.length);
})();
